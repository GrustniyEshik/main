function start () {
    ...
    for (let i = 1; i <= 10; i++) {
        ...
        `<button class="Goods" id="goods${i}"><img src="3IMG/Goods/Good_${i}.png"></button>`
    }


    allGoods = document.getElementById("blockAllGoods");
    allGoods.innerHTML = "";
    for (let i = 1; i <= 10; i++) {
        allGoods.innerHTML = allGoods.innerHTML + 
        `<button class="Goods" id="goods${i}"><img src="3IMG/Goods/Good_${i}.png"></button>`
    }
}
